...
module.exports = {
  ...
  countIndicadorPorTag: (req,res)=>{
    var attr = {
      attributes: ['codigo', 'descricao', [sequelize.fn('count', sequelize.col('Indicadores.tb_indicador_tag.co_indicador')),'numero_indicadores']],
      ...
      order:[[sequelize.fn('count', sequelize.col('Indicadores.tb_indicador_tag.co_indicador')),'DESC']]
    };
