...
alter table dbesusgestor.tb_plano add CONSTRAINT tb_plano_co_plano_pai_fkey FOREIGN KEY (co_plano_pai)
...
COMMENT ON COLUMN dbesusgestor.tb_meta.co_plano IS 'FK para o plano';
...
alter table dbesusgestor.tb_meta add CONSTRAINT tb_meta_plano_fkey FOREIGN KEY (co_plano)
        REFERENCES dbesusgestor.tb_plano (co_plano) MATCH SIMPLE
        ON UPDATE NO ACTION ON DELETE NO ACTION;

alter table dbesusgestor.tb_meta add CONSTRAINT fk_periodicidade_meta FOREIGN KEY (co_periodicidade_monitoramento)
